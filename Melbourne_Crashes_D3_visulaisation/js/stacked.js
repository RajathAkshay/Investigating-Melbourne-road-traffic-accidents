/*global $, d3, _ */
var week = d3.json("data/stacked.json", function(data) {
        console.log(data)
    console.log(data)
var seriesNames = ["Monday", "Tuesday", "Wednesday","Thursday","Friday","Saturday","Sunday"],
    numSamples = 12,
...
//
//function key_val(name){
//var week = d3.json("xyz.json", function(collection) {
...
var chartMode = "stacked",
    ...
    containerHeight = 500,
    margin = {top: 180, right: 50, bottom: 20, left: 40},
...
var xScale = d3.scale.linear()
    .domain(d3.extent(['January', 'February', 'July', 'March', 'April', 'June', 'May', 'August', 'September', 'October', 'December', 'November'], function(d) { return d; }))
    .range([0, width]);
...
var workflow_actions = ['January', 'February', 'July', 'March', 'April', 'June', 'May', 'August', 'September', 'October', 'December', 'November']

var formatDay = function(d) {
    return workflow_actions[d % 12] + "day";      
}
